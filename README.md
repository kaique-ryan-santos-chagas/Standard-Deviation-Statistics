...
* ### Subject: Statistics and data structure
...
* ### Perfect! Now we just need to calculate the standard deviation throught _sqrt()_ function and show the outputs to user.
...
## <img src="https://th.bing.com/th/id/OIP.nqgPbF3Ft36fTWvsoliXwwHaHa?w=168&h=180&c=7&o=5&pid=1.7" width=30/> >> Thanks for reading this readme, thats was my solution to standard deviation problem for my computer science studies.
